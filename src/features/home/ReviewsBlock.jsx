      ...
      <div className={styles.container}>
        ...
        <div className={styles.reviews__slider}>
          <div
            ...
            style={{
              transform: `translateX(calc(-${index} * (100% + 16px)))`,
            }}
          >
            {reviews.map((review) => (
              <div
              ...
              >
                <div
                  className={styles["review-card__rating"]}
                >
                  {"★".repeat(review.rating)}
                </div>

                <p
                  className={styles["review-card__text"]}
                >
                  {review.text}
                </p>
                ...
                >
                  <span
                    className={styles["review-card__author"]}
                  >
                    {review.author}
                  </span>
                  <span
                    className={styles["review-card__type"]}
                  >
                    {review.locationType}
                  </span>
                </div>
